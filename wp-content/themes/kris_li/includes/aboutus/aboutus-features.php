    ...
    <section class="aboutus-content">
        <div class="aboutus-illustrator_container">
            <div class="satisfied-client__illustrator">
                <img class="full-small-gray" src="<?php echo get_template_directory_uri() . '/images/illustration/Component.png' ?>" alt="ddd">
                <img class="full-small-white" src="<?php echo get_template_directory_uri() . '/images/illustration/full-star.png' ?>" alt="ddd">
                <img class="half-large-gray" src="<?php echo get_template_directory_uri() . '/images/illustration/half-star.png' ?>" alt="ddd">
                <div class="satisfied-client__content">
                    <?php if (!empty($satisfied_client)) : ?>
                        <h1>
                            <?php echo $satisfied_client ?>
                        </h1>
